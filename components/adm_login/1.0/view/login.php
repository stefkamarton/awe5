<html>
    ...
    <body>
        ...
        <form autocomplete='off' class='form'>
            <div class='control'>
                <h1>
                    <?php echo T("bejelentkezes") ?>
                </h1>
            </div>
            <div class='control block-cube block-input'>
                <input name='username' placeholder='<?php echo T("felhasznalonev", FALSE) ?>' type='text'>
                <div class='bg-top'>
            ...
            <div class='control block-cube block-input'>
                <input name='password' placeholder='<?php echo T("jelszo", FALSE) ?>' type='password'>
                <div class='bg-top'>
                    <div class='bg-inner'></div>
                </div>
                <div class='bg-right'>
            ...
            <div class='control block-cube block-input'>
                ...
                <div class='bg'>
                    <label for="lng"><b><?php echo T("nyelv", FALSE) ?></b></label>
                    <select name="lng">
